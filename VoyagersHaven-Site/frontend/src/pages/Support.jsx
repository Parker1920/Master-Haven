...
export default function Support() {
  ...
  useEffect(() => {
    getConfig()
      .then((c) => setSimulated(c.stripe_mode !== 'live'))
      .catch(() => {})
  }, [])
    ...
    <>
      ...
      >
        <p className="fine" style={{ textAlign: 'left', marginTop: 4 }}>
          Not a nonprofit. No perks, no obligation. Contract client? Use the invoice tab.
        </p>
      </PageHeader>
      ...
      <section className="section wrap">
        {simulated && (
          <div className="notice" style={{ maxWidth: 620, margin: '0 auto 20px' }}>
            Payment processing is being finalized — this is a live preview and no
            card is charged yet. Real payments switch on the moment Stripe is
            connected.
          </div>
        )}
        <SupportPanel />
