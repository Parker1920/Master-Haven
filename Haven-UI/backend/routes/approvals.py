...
# ============================================================================
# Co-submitted discovery drafts
# ----------------------------------------------------------------------------
# `_sanitize_discoveries_draft` and `_promote_draft_discoveries` now live in
# services/discoveries.py — the single centralized path shared by the pending
# approval flow (here) AND the trusted direct-save flow (save_system). They are
