              ...
              const renderBodyFields = (body, prefix, isMoon) => {
                  ...
                  return (
                    <div className="space-y-2">
                      ...
                      <div className="flex flex-wrap gap-3 text-xs">
                        ...
                        <label className="flex items-center"><input type="checkbox" checked={!!body.swarm_debris} onChange={e => updateEditField(`${prefix}.swarm_debris`, e.target.checked ? 1 : 0)} className={checkCls} />Swarm Debris</label>
                ...
                return (
                  <>
                    ...
                    {(body.ancient_bones || body.vile_brood || body.salvageable_scrap || body.storm_crystals || body.gravitino_balls || body.is_infested || body.is_dissonant || body.is_bubble || body.is_floating_islands || body.swarm_debris || body.trash_debris || body.high_sentinel_activity || body.aggressive_sentinel_activity) && (
                      <div className="mt-1 flex flex-wrap gap-1">
                        ...
                        {body.swarm_debris ? <span className="text-xs px-1.5 py-0.5 rounded bg-yellow-800/60 text-yellow-300">Swarm Debris</span> : null}
                    ...
                    {(body.base_location || formatCoords(body.base_latitude, body.base_longitude)) && (
                      <div className="mt-1 text-gray-300">
                        <span className="text-gray-400">Base Location:</span> {body.base_location}
                        {formatCoords(body.base_latitude, body.base_longitude) && (
                          <span className="ml-1.5 font-mono text-gray-400">📍 {formatCoords(body.base_latitude, body.base_longitude)}</span>
                        )}
                      </div>
                    )}
                    {body.description && (
                              ...
                              <div key={j} className={`mb-2 ${editMode ? 'text-sm bg-gray-700/50 p-2 rounded' : 'text-xs'}`}>
                                {editMode && editData ? (
                                  ...
                                  <>
                                    ...
                                    {(moon.ancient_bones || moon.vile_brood || moon.salvageable_scrap || moon.storm_crystals || moon.gravitino_balls || moon.is_infested || moon.is_dissonant || moon.is_bubble || moon.is_floating_islands || moon.swarm_debris || moon.trash_debris || moon.high_sentinel_activity || moon.aggressive_sentinel_activity) && (
                                      <div className="mt-1 flex flex-wrap gap-1">
                                        ...
                                        {moon.swarm_debris ? <span className="text-[10px] px-1 py-0.5 rounded bg-yellow-800/60 text-yellow-300">Swarm Debris</span> : null}
                        ...
                        {editMode && editData ? (
                          <div className="space-y-2">
                            ...
                            <div className="flex flex-wrap gap-3 text-xs">
                              ...
                              <label className="flex items-center"><input type="checkbox" checked={!!moon.swarm_debris} onChange={e => updateEditField(`moons.${i}.swarm_debris`, e.target.checked ? 1 : 0)} className={checkCls} />Swarm Debris</label>
                          ...
                          <>
                            ...
                            {(moon.ancient_bones || moon.vile_brood || moon.salvageable_scrap || moon.storm_crystals || moon.gravitino_balls || moon.is_infested || moon.is_dissonant || moon.is_bubble || moon.is_floating_islands || moon.swarm_debris || moon.trash_debris || moon.high_sentinel_activity || moon.aggressive_sentinel_activity) && (
                              <div className="mt-1 flex flex-wrap gap-1">
                                ...
                                {moon.swarm_debris ? <span className="px-1.5 py-0.5 rounded text-xs font-medium bg-yellow-800/60 text-yellow-200 border border-yellow-700/50">Swarm Debris</span> : null}
